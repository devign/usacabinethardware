...
#$node_tree = &create_node_tree("$form{cnid}") if (exists($form{cnid}) && $form{cnid} ne '');

%actionCodes = (di => 'cat_detail_item',
        s => 'cat_search',
        b => 'cat_browse',
        cs => 'cat_select_search',
        cbi => 'cat_browse_items');
                    ...
                    &track_session("$session_id", 'CART_ADD');
                        ...
                        if ($key !~ /\_GRP1_qty$/) {
                                ...
                                if (@prodCheck) {
                                        ...
                                        $vend_id = 100 if (!$vend_id || $vend_id eq '');
...
sub cart_clear() {
        ...
        if (exists($form{sa}) && $form{sa} ne 'cart_submit') {
                print qq^ <div style="font-size:16pt">Your cart has been cleared!</div> ^;
        ...
        # PRINT CART CONTENTS   
            print qq^<TR><TD style="text-align:center" style="padding-top:15px">
                       ...
                       <td>      <table border=1 bordercolor=#000000 width=150 cellpadding=5 
                                ...
                                <div style="width:70px;background-image: url(${img_url}floppy-disk.gif); background-position:right;background-repeat: no-repeat;" >
                   ...
                   &nbsp;
                    ...
                    <form style="margin:0" method=post action=\"${cgi_url}usastore.pl\">
                ...
                foreach $result (@$results) {
                        ...
                        print qq^ </TD>
                               <TD class=small style="width:60px">
                                <a href="${cgi_url}usastore.pl?a=di&pid=${prod_id}">
                                <img border="0" src="$prod_image_info[1]" width="40" height="40"></a>
                                </TD> 
                ...
                print qq^<TR><TD colspan=2 class=detail>
                                <input class=formButton type=submit value=\"Recalculate\"></form></td>
                                <TD colspan=3 style="text-align:center" valign=top>
                                <div id="specialMessage">
                                FREE GROUND SHIPPING
                                <p>On orders of <span style="font-size:13pt">\$77</span> or more!</p>
                                <p style="font-size:8pt;font-weight:normal;margin-top:5px">(continental U.S. Only. 25lb shipping weight max - orders
			over 25 pounds and over \$100 will receive discounted shipping)</p>
                                </div>
                                </TD> 
        ...
        # PRINT CART SUMMARY LINES      
          ...
          # QUANTITY DISCOUNT           
                if ($discount != 0 || $form{promo_code}) {
                  # IF PROMO CODE EXISTS, SET PROMO DISCOUNT 
                        ...
                        $sub_total -= $discount;
                        print qq^<TR><TD colspan=7 style="text-align:right;color:firebrick;font-size:11pt"><b>ORDER DISCOUNT:</b></TD>
                                                <TD style="text-align:right;color:firebrick;font-size:11pt"> - \$${discount}</TD></TR>^;
          ...
          # SALES TAX FOR MINNESOTA CUSTOMERS
                if ($form{cust_bstate} eq 'ND' && ($form{sa} eq 'cart_summary' || $form{sa} eq 'cart_submit')) {
                        ...
                        print qq^ <TR><TD colspan=7 style="text-align:right" class=detail><b>ND SALES TAX:</b></TD>
...
#                       }
                        ...
                        print qq^ <tr><td colspan=7 class=detail style="text-align:right">
    ...
    # 10/08/2007 RE-ADDED, DISCOUNT STARTS AT $1000
                ...
                print qq^ <TR><TD colspan=7 style="text-align:right;font-weight:bold;font-size:11pt">
                                <b>CART TOTAL:</b></TD>
                ...
                print qq^
                        <TR><TD style="padding-bottom:0px;padding-top:15px" colspan=9><hr style="padding:0px;margin:0px" noshade></TD></TR>
                        <TR><TD style="padding-top: 0px" colspan=9>
                        <div style="float:left">
                        <img src="${img_url}reasons-to-buy-exp.jpg" alt="15 years experience in hardware, online since 2002">
                        </div>
                        <div style="float:left">
                        ...
                        <div style="text-align:center;font-size:16pt;padding:20px"><a href=\"${LINK}\">
                        <b>$ORDER_TEXT</b></a></div></TD>
                        </TR>
                        <TR>
                         <td colspan=2 align=left>
                        <span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=5mvUEtwua7Lb70t8E2cqJyvQsm9Ru6M3JTzOisKgo1M5POdnIcR7H"></script><br/></span>
                        </td>
                        <TD colspan=2 style="text-align:center" class=detail>
                        <a href=\"${cgi_url}usastore.pl?a=cart_clear&sid=${session_id}\">
                        Clear Cart</a></TD>
                        <TD colspan=3 style="text-align:center" class=detail>
...
sub cart_empty() {
        print qq^<div id="contentContainer">
                ...
                <strong>EMAIL ADDRESS:</strong> <input class="largeInput" type="text" name="cart_owner_email" value="" size="40">
...
sub cscr1() {   
    ...
    &track_session("$session_id", 'CHECKOUT');
        ...
        my $location = $secure_cgi . 'usastore.pl';
        print qq^ <TR><TD><h2 class=top>CHECKOUT</h2></TD></TR></TABLE>
                
                <div style="width:990px;margin-left:100px;text-align:center">
 ...
 <tr>
<td valign="top" style="text-align:center"><h2 class="top">STORE POLICIES</h2>
...
Ordering from our site is just as (or more) secure as ordering over the telephone or through the mail.  We use the latest in 256 bit SSL data encryption technology to secure the connection between your web browser and our state-of-the-art order processing system.  The secure connection continues from our system to Authorize.Net for credit card processing.  Every connection, every step of the way is secured.  Additionally, our system is continously monitered for possible security holes as new vulnerabilities arise, giving us the advantage of staying one-step ahead of possible intruders by maintaining tight system security. <br><br>
    <b><u>COOKIES</u></b><br> 
...
<span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=5mvUEtwua7Lb70t8E2cqJyvQsm9Ru6M3JTzOisKgo1M5POdnIcR7H"></script><br/></span>
        ...
        <td class="small" valign="top">
			...
			NOTE: This applies to orders placed after 8/11/11. All orders placed
			before that date are subject to the return policy in effect at that time.<br/>          
            You may return items within 60 days from shipping date.  All merchandise
    		...
    		below, non-defective returned merchandise is subject to a 10% restocking 
    		fee.
        <p style="color:#D70000">
			If you place a subsequent order of equal or greater value before your 
			return is processed, we will
			WAIVE the restocking fee on your return!!
			</p>
        
        The following brands have these restocking fees:
			<ul>
			<li><b>Buck Snort Lodge Products</b> - 15% restocking fee</li>
      		<li><b>Emenee Hardware</b> - 15% restocking fee</b></li>
			<li><b>Premier Hardware</b> - 15% restocking fee</b></li>
			</ul>
            ...
            <b>ALL SALES ARE FINAL AFTER 60 DAYS. ABSOLUTELY NO CREDIT CAN BE GIVEN AFTER 30 DAYS FROM SHIPMENT DATE.</b>
            <br><br><br>
...
<!-- BEGIN ROW 2 -->    
        ...
        item detail page.<br><br>
			<br />
      		<br />
        	We offer FREE standard ground shipping to the 48 contintental United States
        	on orders over \$77 and are less than 25 pounds total shipping weight. Orders
			that are more than 25 pounds but over \$100 will receive discounted shipping. 
            <br />
			<br />
		A \$5 small order
...
-->
        ...
        procedure above.However, if after viewing the samples you place a full 
		order, we will waive the restocking fees for the returned samples.
...
print qq^ <TR><TD>
               ...
               <div style="text-align:center;margin-left:140px;margin-bottom:150px">

                <table border=1 bgcolor=#C5CDEZ bordercolor=black cellspacing=0 cellpadding=0 width=700>
                <tr>
                <td>
...
print qq^<TR><TD><h2 class=top>CHECKOUT->CUSTOMER INFORMATION</h2></TD></TR></TABLE>

          <div style="text-align:center;margin-left:100px">
                 <form name="billForm" method=post action="${secure_cgi}usastore.pl" onSubmit="return validateBilling(this, '$location')">
                <input type=hidden name=a value=cart_checkout>
                <input type=hidden name=sa value=cscr3> 
                <input type=hidden name=sid value=$session_id>
                <input type=hidden name=ON_discount value="$form{ON_discount}">
                <table width=700 bgcolor=#C5CDEZ bordercolor=black cellpadding=2 cellspacing=0 border=1>
                <tr>
            <td>
...
<input type=text name=cust_email value="$form{cust_email}" size=20 onBlur="validateEmail(this.form, this.value)"></td>
  ...
  <div style="text-align:center;padding-top:20px;font-size:11pt;font-weight:bold">
<input type=checkbox name=ship_same value=Y checked>SHIP TO THIS SAME ADDRESS<br><br>
<input type=submit name=continue value="CONTINUE >>" class="formButton formButtonBig">
...
print qq^<TR><TD><h2 class=top>CHECKOUT->CUSTOMER INFORMATION</h2></TD></TR></TABLE>
            ...
            <div style="text-align:center;margin-left:100px">
                <form name="billForm2" method=post action="${secure_cgi}usastore.pl" onSubmit="return validateBilling(this, '$location')">
                <input type=hidden name=a value=cart_checkout>
                <input type=hidden name=sa value=cscr3> 
                <input type=hidden name=sid value=$session_id>
                <input type=hidden name=ON_discount value="$form{ON_discount}">
...
<div style="text-align:center;font-size:11pt;font-weight:bold;padding-top:20px">
<input type=checkbox name=ship_same value=Y checked>SHIP TO THIS SAME ADDRESS<br><br>
<input type=submit name=continue value="CONTINUE >>" class="formButton formButtonBig">
<input type=hidden name=registered value=$form{registered}>
                </form>
...
sub cscr2a_error() {
        ...
        if ($this_error eq 'invalid') {
                ...
                print qq^<div style="text-align:center;margin-left:200px;margin-top:100px;margin-bottom:100px">
...
print qq^<TR><TD><h2 class=top>CHECKOUT->SHIPPING INFORMATION</h2></TD></TR></TABLE>

          <div style="text-align:center;margin-left:100px">
                <form name="checkoutForm" method=post action="${secure_cgi}usastore.pl" onSubmit="return validateShipping(this, '$location')">
                <input type=hidden name=a value=cart_checkout>
...
<input type=submit name=continue value="CONTINUE >>" class="formButton formButtonBig"></div>
  </div>^;
...
sub cscr4() {
    ...
    &track_session("$session_id", 'CHECKOUT->SHIPPING AND PAYMENT METHOD');
        ...
        print qq^<TR><TD><h2 class=top>CHECKOUT->SHIPPING AND PAYMENT METHOD</h2>
                ...
                <form style="margin:0" name="checkoutForm" method=post action="${secure_cgi}usastore.pl" onSubmit="return validatePayment(this)">
                <input type=hidden name=a value=cart_checkout>
                <input type=hidden name=sa value=cart_summary>  
                <input type=hidden name=sid value=$session_id>
                <input type=hidden name=ON_discount value="$form{ON_discount}">
                <table width=800 bgcolor=#C5CDEZ bordercolor=black cellpadding=2 cellspacing=0 border=1>
                <tr>
            <td width=20%>
        ...
        print qq^</td></tr>
                 ...
                 <td>
                        <table width=630 border=1 cellspacing=0 cellpadding=5> 
...
<div style="text-align:center;padding-top:20px">
  ...
  <input type=submit value="CONTINUE >>" class="formButton formButtonBig">
          </div>
        </div>^;
                foreach my $key (sort keys %form) {
                        if ($key =~ m/^cust_/) {
...
#                ^;
  ...
  #PRINT CUSTOMER INFO
        print qq^ <TR><TD><H2 class=top>CHECKOUT->ORDER SUMMARY</H2></TD></TR></table>
                        
                        <div style="text-align:center;margin-left:95px">
                        <table width=800 cellpadding=5 cellspacing=0 border=1 bordercolor=\"#000000\">
                        <tr>
        ...
        print qq^ </div><input type=hidden name=ord_pay_method value=\"$form{ord_pay_method}\">
                        ...
                        you are agreeing to all of our store policies. Thank you.
                 
                <input class="formButton formButtonBig" style="font-size:14pt" name="ordSubmitBut" type="submit"" value="Submit Order"></div></form> ^;                          
  ...
  ## UNLOCK customers, orders, AND order_details TABLES FOR THIS SESSION
    $ST_DB2 = $DB2_edirect->do("UNLOCK TABLES");
     ...
     &track_session("$session_id", 'CHECKOUT->ORDER SUBMIT');
        ...
        print qq^<TR><TD><H2 class=top>CHECKOUT->ORDER RECEIPT - ORDER# $form{inv_no} </H2></TD></TR></TABLE>
...
print qq^
<script>
var orderID = '$form{inv_no}';
var orderTotal = '$ord_total';
var orderState = 'orderSubmit';
</script>^;
} 
################################## END SUB SUBMIT #############################
###############################################################################
...
###############################################################################
######################## BROWSE MULTIPLE ITEMS FROM URI #######################
sub cat_browse_items() {
	my $index = 1;
	
	$query = "SELECT SQL_CALC_FOUND_ROWS STRAIGHT_JOIN DISTINCT b.brand_id, brand, model_num, group_id, prod_id,  
            detail_descp, size1, size2, finish, unit, price, disc_qty, disc_amt,
            stock, qty_oh, ship_time
            FROM brands AS b
            LEFT JOIN products AS p USING(brand_id)";

	
	my @pids = split(/:/, $form{ids});
	
	foreach my $pid (@pids) {
		if ($index == 1) {
			$query .= " WHERE prod_id = '$pid'";
			$index++;
		} else {
			$query .= " OR prod_id = '$pid'";
		}
	}
			
   	$query .= " and status != 0 GROUP BY group_id, model_num";		
	    
    &cat_display_page("$query"); 
    
}
###################### END SUB cat_browse_items ###############################                                                                                                                                                                                                                                                                         
###############################################################################
...
sub cat_detail_item() {
  ...
  #CHECK TO SEE IF PRODUCT GROUP EXISTS, IF IT DOES, DO THE FIRST BRANCH OF CODE        
        if ($test) {
                ...
                print qq^<div id="prodPageContainer">
                            <div><button class=formButton onClick="javascript:history.back()">&lt;&lt; PREVIOUS PAGE</button></div>
...
<!-- AddThis Button END -->
                        ...
                        <hr noshade size=1 width=100%>
                         ...
                         <div id="prodDetailImageContainer">^;
                                        
                if (-e "${home_dir}img/products/$group_descp[0]/$group_descp[4].jpg") {
                       print qq^<a rel="lightbox" href="${img_url}products/$group_descp[0]/$group_descp[3].jpg">    
                            <img src="${img_url}products/$group_descp[0]/$group_descp[3].jpg" border=0 width=300>^;
                } elsif (-e "${home_dir}img/products/$group_descp[0]/${group_id}.jpg") {
                       print qq^ <a rel="lightbox" href="${img_url}products/$group_descp[0]/${group_id}.jpg">
                            <img src="${img_url}products/$group_descp[0]/${group_id}.jpg" width=300 border=0>^;
                } else {
        ...
        #accessories/related
                ...
                if ($ST_DB->rows != 0) {
                    print "<br><br><b><u>RELATED ITEMS</u></b><br /><span>";
                ...
                $ST_DB->finish(); 
        ## END ACCESSORIES/RELATED                         
                 
                 print qq^                       
                         </div> <!-- close prodDetailImageContainer -->
                                        
                         <div id="prodDetailInfoContainer">
                         <form method=post action=${cgi_url}usastore.pl name="cartForm">
                         <input type=hidden name=a value=cart_add>   
<h1>$group_descp[1]</h1> <br />						 
                         <span style="font-size:12pt;margin-bottom:10px"><b>MODEL #:</b> $group_descp[5]</span><br/>
                         <b>DESCRIPTION:</b>&nbsp;$group_descp[2]<br/>             
                          $group_descp[6]<br/>^;
...
#####GET AND PRINT PRODUCT FEATURES     
                ...
                if ($ST_DB->rows != 0) {
                    print qq^<br /><br /><b><u>FEATURES</u></b><ul id="productFeatures">^;
...
#                }
    ...
    ##DETERMINE IF SPEC IMAGE EXISTS, IF SO PRINT LINK
         if (-e "${home_dir}img/specs/$group_descp[0]/spec-${group_id}\.jpg") {
         	print qq^&nbsp;&nbsp;&nbsp; <a href=\"javascript: productView('${img_url}specs/$group_descp[0]/spec-${group_id}.jpg', '$group_descp[2]')\">Click For Spec Image</a><img src="${img_url}specs/$group_descp[0]/spec-${group_id}.jpg" border=0 width=20 height=20><br />^;
         } elsif (-e "${home_dir}img/specs/$group_descp[0]/spec-${group_id}\.gif") {
         	print qq^&nbsp;&nbsp;&nbsp; <a href=\"javascript: productView('${img_url}specs/$group_descp[0]/spec-${group_id}.gif', '$group_descp[2]')\">Click For Spec Image</a><img src="${img_url}specs/$group_descp[0]/spec-${group_id}.gif" border=0 width=20 height=20><br />^;
         }
                
    ##DETERMINE IF SPEC PDF EXISTS, IF SO PRINT LINK
         if (-e "${home_dir}docs/specs/pdf/$group_descp[0]/${group_id}.pdf") {
         	print qq^&nbsp;&nbsp;&nbsp; <a href="${base_url}docs/specs/pdf/$group_descp[0]/${group_id}.pdf">Click For Spec PDF</a><br />^;
         } 
    ...
    ##END PRINT SPECIFICATIONS
        ...
        if (@$finishes > 0 && -e "${home_dir}img/finishes/$group_descp[0]/") {
            ...
            foreach $finish (@$finishes) {
                ...
                if (-e "${home_dir}img/finishes/$group_descp[0]/$finish_code\.jpg") {
                    print qq^<td class=small style="text-align:center"><a rel="lightbox[finish]" href="${img_url}finishes/$group_descp[0]/$finish_code\.jpg">
     ...
     ######################################   
        ...
        $detail_query = "SELECT brand_id, prod_id, size1, 
                ...
                print qq^<b>SELECT SIZE/FINISH:</b><br />
                <select class="prodSelect" name="${group_id}_pid" onChange="document.getElementById('prodDiv').innerHTML=this.value">^;
        ...
        # INITIALIZE SELECT LIST WITH ITEM SELECTED TO GET TO THIS PAGE        
                ...
                print qq^ </select><br /><br />
                                        <div style="padding-top:10px" class=detail bgcolor="#FDF2B5" colspan="2"><b>QTY:</b> 
                                <input style="text-align:center" type=text name=${group_id}_qty value=\"1\" size=4>
                              ...
                              <br />
                              <br />
                              <input type=submit class="formButton formButtonBig" value=\"ADD TO CART\"><br /></div>^;
                
                
                print qq^</form></div><!-- close prodDetailsInfoContainer -->
                            
                            </div><!-- close prodDetailsContainer -->
                            <div style="margin-left:20px;margin-top:20px;padding-top:30px">
                ...
                if ($case > 0) {
                    ...
                    if ($count_discounts > 1) {
                         print qq^<br><b>- Quantity discounts available, add to cart to see discount.</b><br />^;
                    } else {
                        my $disc_amt = $disc_amt * 100;
                        print qq^<br><b>- $disc_amt\% discount on $case or more!</b><br />^;
                    }
                }               
                                
                print qq^</font>
                            
                              <div style="color:#b0b4c6;font-size:9pt;margin-top:5px;margin-bottom:10px;margin-bottom:10px;margin-left:50px"><span style="font-size:15pt;font-weight:bold">FREE</span>
                                     GROUND SHIPPING ON ORDERS OF <span style="font-size:15pt;font-weight:bold">\$77</span> OR MORE!<br/>
                                     <span style="font-size:9pt;margin-left:25px">(continental U.S. only. 25lb max shipping weight limit - orders
			over 25 pounds and over \$100 will receive discounted shipping)</span><br /></div>
                                                                           &nbsp;
...
#                }
                ...
                print qq^<div id="prodPageContainer">
                                 <button class=formButton onClick=\"javascript:history.back()\">&lt;&lt;PREVIOUS PAGE</button>^;

                
                print qq^ <div style="display:inline;margin-left:0px;float:right">
<!-- AddThis Button BEGIN -->
<div class="addthis_toolbox addthis_default_style" style="display:inline">
<a href="http://www.addthis.com/bookmark.php?v=250&amp;username=xa-4b43a97c04645153" class="addthis_button_compact">Share</a>
<span class="addthis_separator">|</span>
...
<!-- AddThis Button END -->
        ...
        ##DETERMINE IF IMAGE EXISTS AND DISPLAY, ELSE DISPLAY IMAGE_NOT_AVAILABLE
                if (-e "${home_dir}img/products/$result[1]/$result[2]\.jpg") {
                        print qq^<a rel="lightbox" href=\"${img_url}products/$result[1]/$result[2].jpg\">
                                <img border=0 src=\"${img_url}products/$result[1]/$result[2].jpg\" width=300></a>^;
                } elsif (-e "${home_dir}img/products/$result[1]/$result[10]\.jpg") {
                        print qq^<a rel="lightbox" href=\"${img_url}products/$result[1]/$result[10].jpg\">
                ...
                print qq^</div><div id="prodDetailInfoContainer">^;
                
                
            # PRINT LIST OF ITEMS THAT WE PURCHASED WITH THIS ITEM     
                my @items_also_bought = &cust_also_bought("$result[2]");
                
                my $count_also_bought = 0;
                if (@items_also_bought > 0) {
                      print qq^<div style="float:right;margin-left:10px">
                            <div id="itemsAlsoBoughtTitle">
                                ITEMS BOUGHT WITH THIS ITEM</div>
                            <div id="itemsAlsoBought">^;                

                      
                      foreach (@items_also_bought) {
                          my $image = &get_prod_image("$_", 'thmb');
                          
                          print qq^<div><a href=\"${cgi_url}usastore\.pl?a=di&pid=$_\">
                                  <img src=${image} border=0 width=50><br>
                                  $_</a></div>^;     
                ...
                print qq^  <div style="font-size:12pt">
				<h1>$result[0]</h1><br />
				<b>ITEM NO.:</b> $result[2]<br />
                            <b>MODEL NO.:</b> $result[3]<br /><br />
                            </div>                    
                            <b>DESCRIPTION:</b> $result[4]<br />
                            <b>DIMENSIONS:</b> $result[5]&nbsp;&nbsp;&nbsp;&nbsp;$result[6]<br />
                            <b>FINISH:</b> $result[7]<br /><br />^;
 ...
 # END RELATED ITEMS
                ...
                print qq^<div style="margin-top:5px">
                          \$$result[8] $result[9]</div>
                         <form name="frmCartAdd" style="margin:0px" method=post action=${cgi_url}usastore.pl>
                         <input type=hidden name=a value=cart_add>
                         <br /><b>QTY:</b><input type=text name=$result[2]_qty value="1" size=2 style="text-align:center;font-size:11pt">
                         <div style="margin-top:20px"><input type="submit" value="Add Item To Cart" class="formButton formButtonBig"></div>
        <!--                 <a href="javascript:frmCartAdd.submit()">
                         <img onMouseOver="self.status='Add Item To Your Cart';return true" src="${img_url}button-add-to-cart.jpg" border=0 style="margin-bottom:-7px"></a>-->
                          </form></div></div>^;
 


                print qq^<br /><br /><div style="padding-left:20px">
                        <font color=\"#CAAC02\" ><b>NOTES:<br>
                        - Normally ships $ship_time</b>^; 
                ...
                print qq^</div>
                    <div style="color:#b0b4c6;font-size:9pt;margin-top:5px;margin-bottom:10px;margin-left:50px"><span style="font-size:15pt;font-weight:bold">FREE</span> GROUND SHIPPING ON ORDERS OF <span style="font-size:15pt;font-weight:bold">\$77</span> OR MORE!<br/>
                                     <span style="font-size:9pt;margin-left:25px">(continental U.S. only. 25lb max shipping weight limit - orders
			over 25 pounds and over \$100 will receive discounted shipping)</span><br>
                                    </div>
                     <!--                
                                    <div style="border:5px dotted green;padding:5px;margin:10px;text-align:center">
                      Hurry and order your hardware now before the annual price increases take effect!
    ...
    if ($count > 0) {
        ...
        print qq^<div id="subHeader2Container">^;
            ...
            if ($count != 1 && $form{ind} < $count) {
                    print qq^ <div class="subHeader2">$first_item thru 
                            $form{ind} of $count Products Matching</div>^;
            } elsif ($count != 1 && $form{ind} > $count) {
                    print qq^<div class="subHeader2">$first_item thru
                            $count of $count Products Matching</div>^;
            } else {
                print qq^<div class="subHeader2">1 Product Matches</div>^;       
            }
...
#       
		...
		if ($count > 10) {
            print qq^<div class="subHeader2">
                            <form style="margin:0px;padding:0px;display:inline" name="sortForm" method="post" action="usastore.pl">
                                 <input type="hidden" name="a" value="$form{a}">^;
                                 
    
            print qq^<input type="hidden" name="bid" value="$form{bid}">^ if (exists($form{bid}));
            print qq^<input type="hidden" name="cnid" value="$form{cnid}">^ if (exists($form{cnid}));
            print qq^<input type="hidden" name="sv" value="$form{sv}">^ if (exists($form{sv}));
            print qq^<input type="hidden" name="finish" value="$form{finish}">^ if (exists($form{finish}));
            print qq^<input type="hidden" name="size" value="$form{size}">^ if (exists($form{size}));
            
            print qq^<select name="sortBy"  onChange="this.form.submit()">
                     <option>--- SORT RESULTS ---</option>
                     <option value="price-asc">By Price Low to Hi</option>
                     <option value="price-desc">By Price Hi to Low</option>^;
            
            print qq^<option value="detail_descp-asc">By Descripton A to Z</option>
                             <option value="detail_descp-desc">By Description Z to A</option>^;
                                              
            
            if (!exists($form{finish})) {
                print qq^<option value="finish-asc">By Finish A to Z</option>
                             <option value="finish-desc">By Finish Z to A</option>^;
            }
            
            print qq^<option value="size1-asc">By Size Small to Big</option>
                             <option value="size1-desc">By Size Big to Small</option>^;
            
            if (!exists($form{bid})) {
                print qq^<option value="brand-asc">By Brand A to Z</option>
                             <option value="brand-desc">By Brand Z to A</option>^;
            }                             
        ...
        &create_side_nav("$form{cnid}");         
        
        print qq^<div id="toolBox">^;
        
        if (exists($form{bid}) && $form{bid} =~ m/^\d\d\d$/) {
              print qq^<img style="margin-bottom: 30px" src="${img_url}$form{bid}-logo\.gif">^;
        }

        &create_help_nav("$form{cnid}");
                                  
        print qq^</div><div id="prodListingContainer">^;
      ...
      # DECLARE LOCAL VARIABLES FOR BINDING TO DB TABLE COLUMNS
        ...
        while ($ST_DB2->fetch()) {
            print qq^<div class="prodListing">^;
                     ...
                     if ($image_ratio > 1) {            
                         if ($w > 90) {
                             print qq^<a href="usastore.pl?a=di&pid=$prod_id">
                                           <img src="${prod_image_url}" width=90 border=0></a>^;
                         } else {
                         ...
                         if ($h > 90) {
                             print qq^<a href="usastore.pl?a=di&pid=$prod_id">
                                <img src="${prod_image_url}" height=90 border=0></a>^;
                         } else {
                         ...
                         if ($w < 90) { 
                            ...
                            print qq^<a href="usastore.pl?a=di&pid=$prod_id"><img src="${prod_image_url}" width=90 border=0></a>^; 
                         }
                     }     

                  if ($group_id ne '') {
                      my $min_price = $DB_edirect->selectrow_array("SELECT min(price) FROM products
                                                                                  WHERE group_id = '$group_id'");
                      print qq^<div class="prodListingDetailPrice"><span>Starting at</span><br>\$$min_price</div>^; 
                  } else {
                      print qq^<div class="prodListingDetailPrice">\$$price<br><span>$unit</span></div>^;
                  }
                  
                  print qq^<div class="prodListingDetails"><span class="headline">^;
      ...
      #            print "$prod_id";
       #           } 
                  ...
                  if ($group_id ne '') {
                      ...
                      if ($size_count > 1) {                                                            
                          $prodListingLinks = "<span>AVAILABLE IN SEVERAL SIZES";
                      } else {
                          print " - $size1 ";
                      }
                  
                      if ($finish_count > 1) { 
                          if ($prodListingLinks ne '') {
                              $prodListingLinks .= " AND FINISHES</span>";
                          } else {
                              $prodListingLinks = "<span>AVAILABLE IN SEVERAL FINISHES</span>";
                          } 
                      } else {
                        print " - $finish ";
                      }
                      ...
                      if ($prodListingLinks ne '') {
                          print qq^<div class="prodListingLinks"><a href="${cgi_url}usastore.pl?a=di&pid=$prod_id">$prodListingLinks</a></div>^;
                      }
                                                      
                         
                  } else {
                      
                      print qq^$descp - $size1 - $finish^;     
                  } 
                  ...
                  if ($group_id ne '') {
                    ...
                    print qq^</div><div class="prodListingDetailMoreInfo"><a href="${cgi_url}usastore.pl?a=di&pid=$prod_id">more info</a></div><div class="prodListingDetailMoreInfo"><a rel="nofollow" href="${cgi_url}usastore.pl?a=cart_add&${prod_id}_qty=1">add to cart</a></div></div>^;
...
sub cat_search() {
   ...
   #DECLARE VARIABLES FOR THIS SUBROUTINE       
    ...
    my $prod_id_test = $DB_edirect->selectrow_array("SELECT prod_id 
                            FROM prod_to_store pts, store_shelves ssh, store_sections ss
                            WHERE prod_id LIKE '%$form{search_value}%'
                            and ssh.shelf_id = pts.shelf_id
                            and ss.section_id = ssh.section_id 
                            and ss.aisle_id between $cat_id_start and $cat_id_end");
    ...
    if (defined($prod_id_test)) {
        $search_query = "SELECT SQL_CALC_FOUND_ROWS STRAIGHT_JOIN DISTINCT b.brand_id, b.brand, model_num, group_id, p.prod_id, 
                  ...
                  and ss.section_id = ssh.section_id 
                  and ss.aisle_id between $cat_id_start and $cat_id_end
                  and pts.prod_id LIKE '%$form{search_value}%'
                  and status != 0";
        ...
        $search_query = "SELECT SQL_CALC_FOUND_ROWS DISTINCT b.brand_id, b.brand, model_num, group_id, 
                ...
                FROM brands b, products p, prod_to_store pts, store_shelves ssh, store_sections ss, search_index si
                WHERE p.brand_id = b.brand_id
                and pts.prod_id = p.prod_id
                and ss.aisle_id between $cat_id_start and $cat_id_end
...
################################################################################  
############################# SUB selective_search #############################
sub cat_select_search() {
    ...
    if (!$form{st} || $form{st} == 1) {
            ...
            print qq^<div id="contentContainer" style="margin-left:100px;margin-top:30px">
                      <form name=frmEDHSearch method=post action="usastore.pl" onSubmit="this.btnSearchSubmit.value='SEARCHING...';this.btnSearchSubmit.disabled='true'">
                      <input type=hidden name="a" value="cs">
                      <input type=hidden name="st" value="3">
                      <input type=hidden name=t value="$form{t}">

                      <div class="instruct"><b>INSTRUCTIONS:</b><br>
            ...
            if (exists($form{bid}) && $form{bid} ne 'ANY') {
                    ...
                    print qq^<option value="">ANY</option>^;
    ...
    #       }
            ...
            print qq^</select></div><div style="float:right">
            ...
            $query = "SELECT SQL_CALC_FOUND_ROWS STRAIGHT_JOIN DISTINCT b.brand_id, brand, model_num, 
                    group_id, p.prod_id, detail_descp, size1, size2, finish, unit, price, disc_qty, 
                    disc_amt, stock, qty_oh, ship_time
        ...
        if ($form{user_term}) {
            ...
            if ($form{bid} ne '' || $form{finish} ne '' ||
                    $form{cnid} ne '' || $form{size} ne '') {
     ...
     #              } 
                    ...
                    if (exists($form{cnid}) && $form{cnid} eq '') {
                            if (substr("$query", -5) eq 'WHERE') {
                                    $query .= " ss.aisle_id = $cnid";
                            } else {
                                    $query .= " and ss.aisle_id = $cnid";            
