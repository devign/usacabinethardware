...
#                       }
    ...
    # 10/08/2007 RE-ADDED, DISCOUNT STARTS AT $1000
                ...
                print qq^
                        ...
                        <div style="float:left">
                        <img src="${img_url}reasons-to-buy-shipping.jpg" alt="free ground shipping on orders over 199">
                        </div>
                        <div style="float:left">
                        ...
                        <div style="text-align:center;font-size:16pt;padding:10px"><a href=\"${LINK}\">
                ...
                print qq^<div id="prodPageContainer">
                            <div><button class=formButton onClick="javascript:history.back()">&lt;&lt; PREVIOUS PAGE</button></div>
                                ...
                                <div style="float:left">                          
                                        ...
                                        click the <b>\"ADD TO CART\" button</b>.      
                                </div>                    
    ...
    ##END PRINT SPECIFICATIONS
     ...
     ######################################   
        ...
        # INITIALIZE SELECT LIST WITH ITEM SELECTED TO GET TO THIS PAGE        
                ...
                print qq^</div><!-- close prodDetailsInfoContainer -->
                            </form>
                ...
                print qq^</font></div>
                              <div style="color:firebrick;font-size:9pt;margin-top:5px;margin-bottom:10px;margin-bottom:10px;margin-left:50px"><span style="font-size:15pt;font-weight:bold">FREE</span>
...
#                }
                ...
                print qq^<div id="prodDetailContainer">
...
<!-- AddThis Button END -->
              ...
              <table style="border:2px solid #efefef;" cellpadding=10 cellspacing=0 width=960>
              <tr><td class=detail>
        ...
        ##DETERMINE IF IMAGE EXISTS AND DISPLAY, ELSE DISPLAY IMAGE_NOT_AVAILABLE
           ...
           # PRINT LIST OF ITEMS THAT WE PURCHASED WITH THIS ITEM     
                ...
                if (@items_also_bought > 0) {
                      print qq^<td rowspan="12" valign="top">
                ...
                print qq^</tr><tr><td class=detail><b>ITEM NO.:</b> $result[2]<br>
 ...
 # END RELATED ITEMS
		...
		TOP KNOBS REQUIRES A SIGNATURE FOR ALL DELIVERIES</div>^;
                ...
                print qq^</td></tr>
                         ...
                         <tr><td class=detail><form name="frmCartAdd" style="margin:0px" method=post action=${cgi_url}usastore.pl>
                         <input type=hidden name=a value=cart_add><b>QTY:</b><input type=text name=$result[2]_qty value="1" size=2 style="text-align:center;font-size:11pt">
                         <input type="submit" value="Add Item To Cart" class="formButton formButtonBig">
        <!--                 <a href="javascript:frmCartAdd.submit()">
                ...
                print qq^<tr><td class=detail><div style="color:firebrick;font-size:9pt;margin-top:5px;margin-bottom:10px;margin-left:50px"><span style="font-size:15pt;font-weight:bold">FREE</span>
                                     GROUND SHIPPING ON ORDERS OF <span style="font-size:15pt;font-weight:bold">\$77</span> OR MORE!<br/>
                                     <span style="font-size:9pt;margin-left:25px">(continental U.S. only. 25lb max shipping weight limit - orders
